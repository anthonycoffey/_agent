...
> Auto-generated from `agent/n8n/workflows/bugsy-job-board-ui.json` on 2026-05-19. Run `node agent/n8n/scripts/generate-workflow-reference.mjs` to refresh.
...
> Auto-generated from `agent/n8n/workflows/bugsy-job-board-fetcher.json` on 2026-05-19. Run `node agent/n8n/scripts/generate-workflow-reference.mjs` to refresh.
